...
abstract class Controller
{
    ...
    protected $baseUrlApi = "http://localhost:8888/Projet_EatBooker/Projet_EatBooker/Api_MVC/public";  // Base d'url pour l'API
    protected $baseUrlSite = "http://localhost:8888/Projet_EatBooker_appli/Projet_EatBooker/Structure_MVC/public"; //base d'url pour le Site
