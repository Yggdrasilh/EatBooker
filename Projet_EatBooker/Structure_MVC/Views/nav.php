 ...
 <?php
    ...
    function generateNavigation($role)
    {
        switch ($role) {
            case 'user':
                $nav_elements = array(
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/"><button type="button" class="btn btn-light btnNav">Accueil</button></a>',
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public//public/index.php?controller=user&action=profil"><button type="button" class="btn btn-light btnNav">Page profil</button></a>',
                    '<a class="nav" href="#"><button type="button" class="btn btn-light btnNav">Trouver un restaurant</button></a>',
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/index.php?controller=favori&action=findFavoris"><button type="button" class="btn btn-light btnNav">Mes restaurants préférés</button></a>',
                );
                break;
            case 'admin':
                $nav_elements = array(
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/"><button type="button" class="btn btn-light btnNav">Accueil</button></a>',
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public"><button type="button" class="btn btn-light btnNav">Gestion Restaurant</button></a>',
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/index.php?controller=admin&action=update"><button type="button" class="btn btn-light btnNav">Gestion des Utilisateurs</button></a>',
            ...
            case 'restaurant':
                $nav_elements = array(
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/"> <button type="button" class="btn btn-light btnNav"> Accueil </button> </a>',
                    '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/index.php?controller=restaurant&action=find"> <button type="button" class="btn btn-light btnNav"> Page du Restaurant </button> </a>',
