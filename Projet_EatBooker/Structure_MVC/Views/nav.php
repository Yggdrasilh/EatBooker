    ...
    switch ($role) {
        ...
        case 'admin':
            $nav_elements = array(
                ...
                '<a class="nav" href="http://localhost:8888/Projet_EatBooker/Projet_EatBooker/Structure_MVC/public/index.php?controller=Restaurant&action=gestionRestaurantAdmin"><button type="button" class="btn btn-light btnNav">Gestion Restaurant</button></a>',
        ...
        case 'restaurant':
            $nav_elements = array(
                '<a class="nav" href="http://localhost:8888/Projet_EatBooker/Projet_EatBooker/Structure_MVC/public/"> <button type="button" class="btn btn-light btnNav"> Accueil </button> </a>',
                '<a class="nav" href="index.php?controller=Restaurant&action=planningRestaurant"> <button type="button" class="btn btn-light btnNav"> Planning du Restaurant </button> </a>',
                '<a class="nav" href="index.php?controller=Restaurant&action=askResaAConfirm"> <button type="button" class="btn btn-light btnNav"> Gerer les demandes de reservation </button> </a>',
