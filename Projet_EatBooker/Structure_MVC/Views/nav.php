    ...
    switch ($role) {
        case 'user':
            $nav_elements = array(
                ...
                '<a class="nav" href="http://applications/julie/projets_perso/Projet_EatBooker/EatBooker/Projet_EatBooker/Structure_MVC/public/index.php?controller=User&action=profil"><button type="button" class="btn btn-light btnNav">Page profil</button></a>',
